...
export const SIGNALS: Signal[] = [
  ...
  { alias: 'navigation.mapStyle', vssPath: 'Vehicle.Cabin.Infotainment.HMI.MapStyle',
    type: 'enum', values: ['2d', '3d', 'satellite'], label: '地图视角',
    valueLabels: { '2d': '2D', '3d': '3D', satellite: '卫星' },
    access: 'READ_WRITE', changeMode: 'ONCHANGE', permission: '彩', initial: '2d' },
  { alias: 'navigation.mapTraffic', vssPath: 'Vehicle.Cabin.Infotainment.HMI.TrafficLayer',
    type: 'boolean', label: '路况图层',
    access: 'READ_WRITE', changeMode: 'ONCHANGE', permission: '彩', initial: false },
  /** 模拟行驶（演示用）：车标沿当前路线跑一遍。纯显示状态，不动导航本身 */
  { alias: 'navigation.cruise', vssPath: 'Vehicle.Cabin.Infotainment.HMI.CruiseDemo',
    type: 'boolean', label: '模拟行驶',
    access: 'READ_WRITE', changeMode: 'ONCHANGE', permission: '彩', initial: false },
